...
const UslugeRezervacija = () => {
  ...
  return (
    ...
    {/* Dodati kod kog zaposlenog hoce da rezervise termin */}
    <div>
        Provera da li je klasicni korisnik
    </div>
    ...
    {/* Dodati dugmice rezervisi termin, i onda prikazati obavestenje*/}

    {/* Dodati tabelu sa rezervisanim terminima i mogucnosti da azurira i obrise termin*/}
